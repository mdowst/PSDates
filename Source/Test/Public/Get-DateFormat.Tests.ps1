...
Describe 'Get-DateFormat Tests' {
    It 'Get-DateFormat Test' {
        $dateFormat = Get-DateFormat -Date "11/17/2017"
        ...
        $dateFormat.FileTime | Should -Be '131553720000000000'
        ...
        $dateFormat.ISO8601UTC | Should -Be '2017-11-17T06:00:00.000Z'
        ...
        $dateFormat.RFC1123UTC | Should -Be 'Fri, 17 Nov 2017 06:00:00 GMT'
        $dateFormat.RoundTrip | Should -Be '2017-11-17T00:00:00.0000000'
        ...
        $dateFormat.UniversalFullDateTime | Should -Be 'Friday, November 17, 2017 6:00:00 AM'
        $dateFormat.UniversalSortableDateTime | Should -Be '2017-11-17 00:00:00Z'
        $dateFormat.UnixEpochTime | Should -Be '1510898400'
        $dateFormat.WimDatetime | Should -Be '20171117000000.000000-360'
